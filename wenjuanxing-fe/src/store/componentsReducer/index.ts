...
export const componentSlice = createSlice({
    ...
    reducers:{
        ...
        // 添加新组件方法
        addComponent:produce((draft:ComponentsStateType,actions:PayloadAction<ComponentInfoType>)=>{
            // 获取
        ...
        // 修改已有组件属性的方法
        changeComponentProps:produce((draft:ComponentsStateType,actions:PayloadAction<{fe_id:string,newProps:ComponentPropsType}>)=>{
        ...
        // 隐藏/显示已选组件方法
        changeComponentHidden:produce((draft:ComponentsStateType,actions:PayloadAction<{fe_id:string,isHidden:boolean}>)=>{
            // 解构
        ...
        // 锁定/解锁已选组件方法
        toggleComponentLocked:produce((draft:ComponentsStateType,actions:PayloadAction<{fe_id:string}>)=>{
            // 解构出当前已选组件id
        ...
        // 改变组件标题方法
        changeComponentTitle:produce((draft:ComponentsStateType,actions:PayloadAction<{fe_id:string,title:string}>)=>{
            // 解构
        ...
        // 移动组件位置方法
        moveComponent:produce((draft:ComponentsStateType,actions:PayloadAction<{ oldIndex:number; newIndex:number }>)=>{
            // 解构
            const {componentList}=draft
...
// 导出actions
export const {moveComponent,changeComponentTitle,selectNextComponent,selectPreComponent, pasteCopiedComponent,copySelectedComponent,toggleComponentLocked,changeComponentHidden,resetComponent,changeSelectedId,addComponent,changeComponentProps,removeSelectComponent} = componentSlice.actions 
