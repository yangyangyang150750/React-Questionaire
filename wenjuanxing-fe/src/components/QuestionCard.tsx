...
import { Button, Space ,Divider, Tag, Typography, message, Popconfirm} from "antd";
...
const QuestionCard:FC<PropsType> = (props:PropsType)=>{
    ...
    // 解构属性
    const {_id,title,isPublished,answerCount,createdAt,isStar,isDeleted} = props
    ...
    const {loading:deleteLoading,run:deleteQuestion}=useRequest(async()=>{
      // 发送请求
      const data =await (updateQuestionServe(_id,{isDeleted:true}))as ResDataType
